...
/**
 * The shape of a webpack/rspack `require.context(...)` return value.
 *
 * Exported so consumers can type their own `require.context` call without
 * relying on an ambient global declaration (bundler-provided or otherwise).
 */
