...
describe("Dataview JS Snippet", () => {
	...
	it("has the Dataview plugin enabled", async () => {
	...
	it("the bundle evaluates to a function (same path as the snippet)", async () => {
		const result = await browser.executeObsidian(async ({ app }, vaultPath) => {
	...
	it("renders index.md without a Dataview error", async () => {
